...
(function( $ ) {
    ...
    $.fn.thooClock = function(options) {
       ...
       defaults = {
            ...
            el.dateStart = settings.dateStart;
            el.dateStartOriginal = new Date();
            ...
            $.fn.thooClock.setTime = function(newtime){
                    el.dateStart = newtime;
                    el.dateStartOriginal = new Date();
            };
            ...
            function startClock(x,y){
                ...
                var diffTime = new Date() - el.dateStartOriginal;
                theDate = new Date(formatDate(el.dateStart, "yyyy-MM-dd HH:mm:ss"));
